...
//         bounceDamping: 20,
//       }}
//       className="relative flex-shrink-0 w-52 h-65 rounded-[40px] bg-zinc-900/90 text-white px-6 py-8 overflow-hidden"
//     >
//       <span className="flex items-center justify-between gap-2">
//         {icon} {label}
//         <span className="flex items-center justify-center gap-2">
...
//       <p className="text-sm mt-6 leading-tight">{data.desc}</p>
...
//            <span onClick={() => onEdit(data)} className="w-6 h-6 bg-sky-600 rounded-full flex items-center justify-center cursor-pointer">
//              <CiEdit />
//            </span>
...
//           <div
//             onClick={() => window.open(fileURL, "_blank")}
//             className="tag w-full py-4 flex items-center justify-center text-center cursor-pointer bg-green-600"
//           >
//             <h3 className="text-sm font-semibold">Read Now</h3>
//           </div>
//         )}
//       </div>
//     </motion.div>
